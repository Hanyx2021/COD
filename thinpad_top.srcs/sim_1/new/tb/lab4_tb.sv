...
module lab4_tb;
  ...
  parameter BASE_RAM_INIT_FILE = "F:\HYXlearning\cod\projects\sram\base.bin"; // BaseRAM 初始化文件，请修改为实际的绝对路径
  parameter EXT_RAM_INIT_FILE = "F:\HYXlearning\cod\projects\sram\ext.bin";  // ExtRAM 初始化文件，请修改为实际的绝对路径
